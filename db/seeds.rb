...
SysConfig.find_or_create_by gem: '平台', key: 'SYS_TITLE', value: '派悦坊', desc: '显示在页面标题栏的系统名称'
SysConfig.find_or_create_by gem: '平台', key: 'SYS_SUBTITLE', value: '派悦坊小程序支撑平台', desc: '显示在页面标题栏的系统名称'
